    ...
    <div class="table-responsive mt-4">
        <form method="post">
            <div class="form-group">
                ...
                <input type="name" class="form-control" value="<?php echo $customer['firstname']?>" name="firstname" required>
            </div>
            <div class="form-group">
                <label for="lastname">Lastname</label>
                <input type="name" class="form-control" value="<?php echo $customer['lastname']?>" name="lastname" required>
            </div>
            <div class="form-group">
                <label for="email">Email address</label>
                <input type="email" class="form-control" aria-describedby="emailHelp" value="<?php echo $customer['email']?>" name="email" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-check">
                <input type="checkbox" class="form-check-input" id="exampleCheck1" name="Premium_member" <?php if($customer['premium_member'] == 1){echo'checked';} ?>>
